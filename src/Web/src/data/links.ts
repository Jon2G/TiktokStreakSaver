...
export const PRIVACY_URL = 'https://github.com/Jon2G/TiktokStreakSaver/blob/main/PRIVACY.md'
export const ISSUES_URL = 'https://github.com/Jon2G/TiktokStreakSaver/issues'
export const LICENSE_URL = 'https://github.com/Jon2G/TiktokStreakSaver/blob/main/LICENSE'
